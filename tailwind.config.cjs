const defaultTheme = {
  colors: {
    ...
    purple: {
      ...
      400: 'hsla(245, 96%, 58%, 1)',
      DEFAULT: 'hsla(245, 96%, 68%, 1)',
      600: 'hsla(245, 96%, 63%, 1)',
    ...
    red: {
      0: 'hsla(341, 43%, 73%, 1)',
      100: 'hsla(341, 43%, 68%, 1)',
      200: 'hsla(341, 43%, 63%, 1)',
      300: 'hsla(341, 43%, 58%, 1)',
      400: 'hsla(341, 43%, 53%, 1)',
      DEFAULT: 'hsla(341, 43%, 47%, 1)',
      600: 'hsla(341, 43%, 42%, 1)',
      700: 'hsla(341, 43%, 37%, 1)',
      800: 'hsla(341, 43%, 32%, 1)',
      900: 'hsla(341, 43%, 27%, 1)',
      1000: 'hsla(341, 43%, 12%, 1)',
      transparent: 'hsla(341, 43%, 47%, 0.8)',
      hex: '#AA4465',
    },
    blue: {
      0: 'hsla(218, 96%, 88%, 1)',
  ...
  boxShadow: {
    ...
    red: '0px 0px 4px 4px hsla(341, 43%, 47%, 0.5)',
      ...
      themes: [
        ...
        },
        {
          ...
          extend: {
            ...
            boxShadow: {
              ...defaultTheme.boxShadow,
              main: defaultTheme.boxShadow.red,
            },
          },
        },
        {
